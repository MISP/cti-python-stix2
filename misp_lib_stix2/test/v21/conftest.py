...
def indicator(uuid4, clock):
    return misp_lib_stix2.v21.Indicator(**INDICATOR_KWARGS)
...
def grouping(uuid4, clock):
    return misp_lib_stix2.v21.Grouping(**GROUPING_KWARGS)


@pytest.fixture
def malware(uuid4, clock):
    return misp_lib_stix2.v21.Malware(**MALWARE_KWARGS)


@pytest.fixture
def relationship(uuid4, clock):
    return misp_lib_stix2.v21.Relationship(**RELATIONSHIP_KWARGS)
...
def real_stix_objs2(stix_objs2):
    return [misp_lib_stix2.parse(x, version="2.1") for x in stix_objs2]
