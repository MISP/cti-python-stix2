...
def test_or_observable_expression():
    ...
    exp = misp_lib_stix2.OrObservationExpression([
        misp_lib_stix2.ObservationExpression(exp1),
        misp_lib_stix2.ObservationExpression(exp2),
        misp_lib_stix2.ObservationExpression(exp3),
    ])
...
def test_timestamp():
    ts = misp_lib_stix2.TimestampConstant('2014-01-13T07:03:17Z')
...
def test_invalid_timestamp_constant():
    with pytest.raises(ValueError):
        misp_lib_stix2.TimestampConstant('foo')
...
def test_startstop_qualifier():
    qual = misp_lib_stix2.StartStopQualifier(
        misp_lib_stix2.TimestampConstant('2016-06-01T00:00:00Z'),
    ...
    qual2 = misp_lib_stix2.StartStopQualifier(
        ...
        misp_lib_stix2.TimestampConstant('2016-07-01T00:00:00Z'),
    )
