...
import misp_lib_stix2.registry as mappings
import misp_lib_stix2.version
...
def is_stix_type(value, stix_version=misp_lib_stix2.version.DEFAULT_VERSION, *types):
    """
